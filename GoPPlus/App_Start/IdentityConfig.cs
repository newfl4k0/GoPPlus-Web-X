...
namespace GoPS
{
    public class EmailService : IIdentityMessageService
    {
        ...
        {
            var mailClient = new GoPS.Classes.GmailEmailService();
            MailMessage email = new MailMessage(new MailAddress(mailClient.UserName, "(do not reply)"),
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        //public static IdentityResult AddToRole(this ApplicationUserManager userManager, string userId, string roleName, int? ID_Afiliado)
        //{
        //    try
        //    {
