    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.SetTwoFactorSuccess ? "Su autenticación de dos factores ha sido establecido."
                ...
                : message == ManageMessageId.RemovePhoneSuccess ? "u número de teléfono fue eliminado."
                : "";
        ...
        public async Task<ActionResult> VerifyPhoneNumber(VerifyPhoneNumberViewModel model)
        {
            ...
            ModelState.AddModelError("PhoneNumber", "No se pudo verificar el teléfono");
            return View(model);
        }
